      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="order-2 lg:order-1">
            ...
            {/* Quote */}
            <div 
              className={`relative bg-film-dark p-6 mb-8 transition-all duration-1000 hover:-translate-y-1 hover:shadow-xl hover:shadow-film-orange/10 ${
            ...
            >
              {socialLinks.map((social, index) => (
                <a
                  ...
                  className={`w-12 h-12 bg-film-dark flex items-center justify-center text-white hover:bg-film-orange hover:scale-110 ${
